...
func main() {
	...
	r.GET("/service_b", func(c *gin.Context) {
		span, ctx := apm.StartSpan(c.Request.Context(), "ServiceBHandler", "request")
		defer span.End()
	...
	r.Run(":8081") // Start server on 0.0.0.0:8081
}
